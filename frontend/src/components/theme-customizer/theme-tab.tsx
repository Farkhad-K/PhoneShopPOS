                  ...
                  <div className="flex items-center gap-2">
                    <div className="flex gap-1">
                      <div
                        ...
                        style={{
                          backgroundColor: theme.preset.styles?.light?.primary || theme.preset.activeColor?.light || "#000000",
                        }}
                      />
                      <div
                        className="w-3 h-3 rounded-full border border-border/20"
                        style={{
                          backgroundColor: theme.preset.styles?.light?.secondary || theme.preset.activeColor?.light || "#000000",
                        }}
                      />
                      <div
                        className="w-3 h-3 rounded-full border border-border/20"
                        style={{
                          backgroundColor: theme.preset.styles?.light?.accent || theme.preset.activeColor?.light || "#000000",
                        }}
                      />
                      <div
                        className="w-3 h-3 rounded-full border border-border/20"
                        style={{
                          backgroundColor: theme.preset.styles?.light?.muted || theme.preset.activeColor?.light || "#000000",
                        }}
                      />
                    </div>
